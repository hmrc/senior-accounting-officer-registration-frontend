...
echo "$packageName$.$className;format="decap"$.error.nonNumeric = Enter your $className;format="decap"$ using numbers and a decimal point" >> ../conf/messages.en
echo "$packageName$.$className;format="decap"$.error.required = Enter your $className;format="decap"$" >> ../conf/messages.en
echo "$packageName$.$className;format="decap"$.error.invalidNumeric = Enter your $className;format="decap"$ using up to two decimal places" >> ../conf/messages.en
echo "$packageName$.$className;format="decap"$.error.aboveMaximum = $className$ must be {0} or less" >> ../conf/messages.en
echo "$packageName$.$className;format="decap"$.error.belowMinimum = $className$ must be {0} or more" >> ../conf/messages.en
