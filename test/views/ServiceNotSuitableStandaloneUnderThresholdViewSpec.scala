...
import views.html.ServiceNotSuitableStandaloneUnderThresholdView

import scala.jdk.CollectionConverters.*

class ServiceNotSuitableStandaloneUnderThresholdViewSpec extends SpecBase with GuiceOneAppPerSuite {

  val SUT: ServiceNotSuitableStandaloneUnderThresholdView =
    app.injector.instanceOf[ServiceNotSuitableStandaloneUnderThresholdView]
  ...
  "ServiceNotSuitableStandaloneUnderThresholdView" - {
    "must generate a view" - {
      ...
      "with the correct heading" in {
        ...
        h1.get(0)
          .text() mustBe "Your company does not need to submit a Senior Accounting Officer notification and certificate"
      }
      ...
      "with the correct paragraphs" in {
        ...
        paragraphs
          .get(1)
          .text() mustBe "If your company meets either of these thresholds in a future financial year, you may need to submit a notification and certificate then."
