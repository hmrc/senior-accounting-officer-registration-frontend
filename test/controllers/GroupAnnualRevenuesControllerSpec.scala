...
class GroupAnnualRevenuesControllerSpec extends SpecBase with MockitoSugar {
  ...
  "GroupAnnualRevenues Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, groupAnnualRevenuesRoute)
