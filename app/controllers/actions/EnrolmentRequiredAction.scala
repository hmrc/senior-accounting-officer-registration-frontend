...
trait EnrolmentRequiredAction
    extends ActionBuilder[EnroledRequest, AnyContent]
    with ActionFunction[Request, EnroledRequest]

final class EnrolmentRequiredActionImpl @Inject() (
    override val authConnector: AuthConnector,
    config: AppConfig,
    override val parser: BodyParsers.Default
)(implicit val executionContext: ExecutionContext)
    extends EnrolmentRequiredAction
